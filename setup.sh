...
echo "  Next Steps:"
echo ""
echo "  1. Edit .env — add your exchange API keys for live trading:"
echo "     ${EDITOR:-nano} .env"
echo ""
echo "     Paper mode needs NO exchange keys and no LLM keys."
echo ""
echo "  2. Test in paper mode (minimal 1-symbol strategy):"
echo "     source venv/bin/activate"
echo "     python main.py --paper --strategy paper_test --cycle-once"
echo ""
echo "  3. Run the daemon continuously (minimal):"
echo "     python main.py --paper --strategy paper_test"
echo ""
echo "  4. Switch to full strategy when ready (hot-plug, no restart needed):"
echo "     python main.py --paper --strategy momentum_rising"
echo ""
echo "  5. (Optional) Add LLM API keys for enhanced analysis:"
echo "     LLM integration is optional — the system runs fully without it."
echo ""
echo "  Log file: logs/auto-trader.log"
echo "  Database: data/auto_trader.db"
echo ""
