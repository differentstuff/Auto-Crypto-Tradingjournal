...
python scripts/analyze_backtest.py --log temp/backtest-stdout-full.log --summary --action trade_open
...
python scripts/analyze_backtest.py --log temp/backtest-stdout-full.log --include-exits --summary
```
